...
const policies = [
  ...
  },
  {
    ...
    icon: Mail,
    title: "Inquiries",
    content: "For urgent inquiries regarding AI Transparency Policy, please contact our legal team at legal@cura-ai.com."
  }
];
  ...
  return (
    <div className="bg-slate-50 min-h-screen text-slate-800 font-sans pb-32">
      ...
      <header className="max-w-4xl mx-auto pt-24 px-8 text-center mb-16">
        ...
        >
          <Sparkles className="w-4 h-4" /> Legal & Compliance
        </motion.div>
        <motion.h1 
        ...
        >
          How our AI models make decisions and process data.
        </motion.p>
      </header>
