...
const policies = [
  ...
  },
  {
    ...
    icon: Mail,
    title: "Inquiries",
    content: "For urgent inquiries regarding Contact & Support, please contact our legal team at legal@cura-ai.com."
  }
];
  ...
  return (
    <div className="bg-slate-50 min-h-screen text-slate-800 font-sans pb-32">
      ...
      <header className="max-w-4xl mx-auto pt-24 px-8 text-center mb-16">
        ...
        >
          <Mail className="w-4 h-4" /> Legal & Compliance
        </motion.div>
        <motion.h1 
        ...
        >
          Get in touch with our support and legal teams.
        </motion.p>
      </header>
