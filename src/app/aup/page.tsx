...
import { CheckSquare, FileText, Clock, Mail } from "lucide-react";
...
const policies = [
  ...
  },
  {
    ...
    icon: Mail,
    title: "Inquiries",
    content: "For urgent inquiries regarding Acceptable Use Policy, please contact our legal team at legal@cura-ai.com."
  }
];
  ...
  return (
    <div className="bg-slate-50 min-h-screen text-slate-800 font-sans pb-32">
      ...
      <header className="max-w-4xl mx-auto pt-24 px-8 text-center mb-16">
        ...
        >
          <CheckSquare className="w-4 h-4" /> Legal & Compliance
        </motion.div>
        <motion.h1 
        ...
        >
          Guidelines for using CURA safely and responsibly.
        </motion.p>
      </header>
